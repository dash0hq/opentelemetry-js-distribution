...
export interface Metric {
  ...
  exponential_histogram?: ExponentialHistogram | undefined;
  summary?:
    | Summary
    | undefined;
  /**
...
export interface SummaryDataPoint {
   ...
   */
  quantile_values: SummaryDataPoint_ValueAtQuantile[];
  /**
   * Flags that apply to this specific data point.  See DataPointFlags
   * for the available flags and their meaning.
   */
...
function createBaseResourceMetrics(): ResourceMetrics {
  return { resource: undefined, scope_metrics: [], schema_url: "" };
}
...
export const ResourceMetrics = {
  encode(message: ResourceMetrics, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    for (const v of message.scope_metrics) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          message.scope_metrics.push(ScopeMetrics.decode(reader, reader.uint32()));
          continue;
        case 3:
          if (tag !== 26) {
            break;
  ...
  fromJSON(object: any): ResourceMetrics {
    return {
      ...
      scope_metrics: globalThis.Array.isArray(object?.scope_metrics)
  ...
  toJSON(message: ResourceMetrics): unknown {
    ...
    if (message.scope_metrics?.length) {
      obj.scope_metrics = message.scope_metrics.map((e) => ScopeMetrics.toJSON(e));
    }
    if (message.schema_url !== "") {
  ...
  fromPartial<I extends Exact<DeepPartial<ResourceMetrics>, I>>(object: I): ResourceMetrics {
    ...
    message.resource = (object.resource !== undefined && object.resource !== null)
      ...
      : undefined;
    message.scope_metrics = object.scope_metrics?.map((e) => ScopeMetrics.fromPartial(e)) || [];
...
function createBaseScopeMetrics(): ScopeMetrics {
  return { scope: undefined, metrics: [], schema_url: "" };
}
...
function createBaseMetric(): Metric {
  return {
    ...
    sum: undefined,
    histogram: undefined,
    exponential_histogram: undefined,
    summary: undefined,
    metadata: [],
  };
}
...
export const Metric = {
  encode(message: Metric, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.exponential_histogram !== undefined) {
      ExponentialHistogram.encode(message.exponential_histogram, writer.uint32(82).fork()).ldelim();
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 10:
          ...
          message.exponential_histogram = ExponentialHistogram.decode(reader, reader.uint32());
          continue;
        case 11:
          if (tag !== 90) {
            break;
  ...
  fromJSON(object: any): Metric {
    return {
      ...
      exponential_histogram: isSet(object.exponential_histogram)
        ? ExponentialHistogram.fromJSON(object.exponential_histogram)
        : undefined,
  ...
  toJSON(message: Metric): unknown {
    ...
    if (message.exponential_histogram !== undefined) {
      obj.exponential_histogram = ExponentialHistogram.toJSON(message.exponential_histogram);
    }
    if (message.summary !== undefined) {
  ...
  fromPartial<I extends Exact<DeepPartial<Metric>, I>>(object: I): Metric {
    ...
    message.histogram = (object.histogram !== undefined && object.histogram !== null)
      ...
      : undefined;
    message.exponential_histogram =
      (object.exponential_histogram !== undefined && object.exponential_histogram !== null)
        ? ExponentialHistogram.fromPartial(object.exponential_histogram)
        : undefined;
...
export const Gauge = {
  encode(message: Gauge, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    for (const v of message.data_points) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          message.data_points.push(NumberDataPoint.decode(reader, reader.uint32()));
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): Gauge {
    return {
      data_points: globalThis.Array.isArray(object?.data_points)
  ...
  toJSON(message: Gauge): unknown {
    const obj: any = {};
    if (message.data_points?.length) {
      obj.data_points = message.data_points.map((e) => NumberDataPoint.toJSON(e));
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<Gauge>, I>>(object: I): Gauge {
    const message = createBaseGauge();
    message.data_points = object.data_points?.map((e) => NumberDataPoint.fromPartial(e)) || [];
    return message;
  },
};

function createBaseSum(): Sum {
  return { data_points: [], aggregation_temporality: 0, is_monotonic: false };
}
...
export const Sum = {
  encode(message: Sum, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.aggregation_temporality !== 0) {
      writer.uint32(16).int32(message.aggregation_temporality);
    }
    if (message.is_monotonic !== false) {
      writer.uint32(24).bool(message.is_monotonic);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          message.aggregation_temporality = reader.int32() as any;
          continue;
        case 3:
          if (tag !== 24) {
            break;
          ...
          message.is_monotonic = reader.bool();
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): Sum {
    return {
      data_points: globalThis.Array.isArray(object?.data_points)
        ? object.data_points.map((e: any) => NumberDataPoint.fromJSON(e))
        : [],
      aggregation_temporality: isSet(object.aggregation_temporality)
        ? aggregationTemporalityFromJSON(object.aggregation_temporality)
        : 0,
      is_monotonic: isSet(object.is_monotonic) ? globalThis.Boolean(object.is_monotonic) : false,
    };
  },
  ...
  toJSON(message: Sum): unknown {
    ...
    if (message.aggregation_temporality !== 0) {
      obj.aggregation_temporality = aggregationTemporalityToJSON(message.aggregation_temporality);
    }
    if (message.is_monotonic !== false) {
      obj.is_monotonic = message.is_monotonic;
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<Sum>, I>>(object: I): Sum {
    const message = createBaseSum();
    message.data_points = object.data_points?.map((e) => NumberDataPoint.fromPartial(e)) || [];
    message.aggregation_temporality = object.aggregation_temporality ?? 0;
    message.is_monotonic = object.is_monotonic ?? false;
    return message;
  },
};

function createBaseHistogram(): Histogram {
  return { data_points: [], aggregation_temporality: 0 };
}
...
export const Histogram = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          message.data_points.push(HistogramDataPoint.decode(reader, reader.uint32()));
          continue;
        case 2:
          if (tag !== 16) {
            break;
  ...
  toJSON(message: Histogram): unknown {
    const obj: any = {};
    if (message.data_points?.length) {
      obj.data_points = message.data_points.map((e) => HistogramDataPoint.toJSON(e));
    }
    if (message.aggregation_temporality !== 0) {
      obj.aggregation_temporality = aggregationTemporalityToJSON(message.aggregation_temporality);
    }
  ...
  fromPartial<I extends Exact<DeepPartial<Histogram>, I>>(object: I): Histogram {
    const message = createBaseHistogram();
    message.data_points = object.data_points?.map((e) => HistogramDataPoint.fromPartial(e)) || [];
    message.aggregation_temporality = object.aggregation_temporality ?? 0;
    return message;
  },
};
...
export const ExponentialHistogram = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          message.data_points.push(ExponentialHistogramDataPoint.decode(reader, reader.uint32()));
          continue;
        case 2:
          if (tag !== 16) {
            break;
  ...
  toJSON(message: ExponentialHistogram): unknown {
    const obj: any = {};
    if (message.data_points?.length) {
      obj.data_points = message.data_points.map((e) => ExponentialHistogramDataPoint.toJSON(e));
    }
    if (message.aggregation_temporality !== 0) {
      obj.aggregation_temporality = aggregationTemporalityToJSON(message.aggregation_temporality);
    }
  ...
  fromPartial<I extends Exact<DeepPartial<ExponentialHistogram>, I>>(object: I): ExponentialHistogram {
    const message = createBaseExponentialHistogram();
    message.data_points = object.data_points?.map((e) => ExponentialHistogramDataPoint.fromPartial(e)) || [];
    message.aggregation_temporality = object.aggregation_temporality ?? 0;
    return message;
  },
};
...
export const Summary = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          message.data_points.push(SummaryDataPoint.decode(reader, reader.uint32()));
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  toJSON(message: Summary): unknown {
    const obj: any = {};
    if (message.data_points?.length) {
      obj.data_points = message.data_points.map((e) => SummaryDataPoint.toJSON(e));
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<Summary>, I>>(object: I): Summary {
    const message = createBaseSummary();
    message.data_points = object.data_points?.map((e) => SummaryDataPoint.fromPartial(e)) || [];
    return message;
  },
};
...
export const NumberDataPoint = {
  encode(message: NumberDataPoint, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.start_time_unix_nano !== "0") {
      writer.uint32(17).fixed64(message.start_time_unix_nano);
    }
    if (message.time_unix_nano !== "0") {
      writer.uint32(25).fixed64(message.time_unix_nano);
    }
    if (message.as_double !== undefined) {
      writer.uint32(33).double(message.as_double);
    }
    if (message.as_int !== undefined) {
      writer.uint32(49).sfixed64(message.as_int);
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 4:
          ...
          message.as_double = reader.double();
          continue;
        case 6:
          if (tag !== 49) {
            break;
          ...
          message.as_int = longToString(reader.sfixed64() as Long);
          continue;
        case 5:
          if (tag !== 42) {
            break;
  ...
  fromJSON(object: any): NumberDataPoint {
    return {
      ...
      as_double: isSet(object.as_double) ? globalThis.Number(object.as_double) : undefined,
      as_int: isSet(object.as_int) ? globalThis.String(object.as_int) : undefined,
  ...
  toJSON(message: NumberDataPoint): unknown {
    ...
    if (message.as_double !== undefined) {
      obj.as_double = message.as_double;
    }
    if (message.as_int !== undefined) {
      obj.as_int = message.as_int;
    }
  ...
  fromPartial<I extends Exact<DeepPartial<NumberDataPoint>, I>>(object: I): NumberDataPoint {
    ...
    message.as_double = object.as_double ?? undefined;
    message.as_int = object.as_int ?? undefined;
...
export const HistogramDataPoint = {
  encode(message: HistogramDataPoint, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    for (const v of message.explicit_bounds) {
      writer.double(v);
    }
    writer.ldelim();
    for (const v of message.exemplars) {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): HistogramDataPoint {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 6:
          if (tag === 49) {
            message.bucket_counts.push(longToString(reader.fixed64() as Long));
        ...
        case 7:
          if (tag === 57) {
            message.explicit_bounds.push(reader.double());
  ...
  fromJSON(object: any): HistogramDataPoint {
    return {
      ...
      bucket_counts: globalThis.Array.isArray(object?.bucket_counts)
        ? object.bucket_counts.map((e: any) => globalThis.String(e))
        : [],
      explicit_bounds: globalThis.Array.isArray(object?.explicit_bounds)
  ...
  toJSON(message: HistogramDataPoint): unknown {
    ...
    if (message.bucket_counts?.length) {
      obj.bucket_counts = message.bucket_counts;
    }
    if (message.explicit_bounds?.length) {
      obj.explicit_bounds = message.explicit_bounds;
    }
    if (message.exemplars?.length) {
      obj.exemplars = message.exemplars.map((e) => Exemplar.toJSON(e));
    }
  ...
  fromPartial<I extends Exact<DeepPartial<HistogramDataPoint>, I>>(object: I): HistogramDataPoint {
    ...
    message.explicit_bounds = object.explicit_bounds?.map((e) => e) || [];
    message.exemplars = object.exemplars?.map((e) => Exemplar.fromPartial(e)) || [];
    message.flags = object.flags ?? 0;
...
export const ExponentialHistogramDataPoint = {
  encode(message: ExponentialHistogramDataPoint, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.zero_count !== "0") {
      writer.uint32(57).fixed64(message.zero_count);
    }
    ...
    if (message.zero_threshold !== 0) {
      writer.uint32(113).double(message.zero_threshold);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 7:
          ...
          message.zero_count = longToString(reader.fixed64() as Long);
          continue;
        case 8:
          if (tag !== 66) {
            break;
        ...
        case 14:
          ...
          message.zero_threshold = reader.double();
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): ExponentialHistogramDataPoint {
    return {
      ...
      zero_count: isSet(object.zero_count) ? globalThis.String(object.zero_count) : "0",
      ...
      min: isSet(object.min) ? globalThis.Number(object.min) : undefined,
      max: isSet(object.max) ? globalThis.Number(object.max) : undefined,
      zero_threshold: isSet(object.zero_threshold) ? globalThis.Number(object.zero_threshold) : 0,
    };
  },
  ...
  toJSON(message: ExponentialHistogramDataPoint): unknown {
    ...
    if (message.zero_count !== "0") {
      obj.zero_count = message.zero_count;
    }
    if (message.positive !== undefined) {
    ...
    if (message.zero_threshold !== 0) {
      obj.zero_threshold = message.zero_threshold;
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<ExponentialHistogramDataPoint>, I>>(
    ...
    message.zero_count = object.zero_count ?? "0";
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ExponentialHistogramDataPoint_Buckets {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          if (tag === 16) {
            message.bucket_counts.push(longToString(reader.uint64() as Long));
...
export const SummaryDataPoint = {
  encode(message: SummaryDataPoint, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    for (const v of message.quantile_values) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 6:
          ...
          message.quantile_values.push(SummaryDataPoint_ValueAtQuantile.decode(reader, reader.uint32()));
          continue;
        case 8:
          if (tag !== 64) {
            break;
  ...
  fromJSON(object: any): SummaryDataPoint {
    return {
      ...
      quantile_values: globalThis.Array.isArray(object?.quantile_values)
  ...
  toJSON(message: SummaryDataPoint): unknown {
    ...
    if (message.quantile_values?.length) {
      obj.quantile_values = message.quantile_values.map((e) => SummaryDataPoint_ValueAtQuantile.toJSON(e));
    }
    if (message.flags !== 0) {
      obj.flags = Math.round(message.flags);
    }
  ...
  fromPartial<I extends Exact<DeepPartial<SummaryDataPoint>, I>>(object: I): SummaryDataPoint {
    ...
    message.quantile_values = object.quantile_values?.map((e) => SummaryDataPoint_ValueAtQuantile.fromPartial(e)) || [];
    message.flags = object.flags ?? 0;
    return message;
  },
};
...
export const Exemplar = {
  encode(message: Exemplar, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    for (const v of message.filtered_attributes) {
      KeyValue.encode(v!, writer.uint32(58).fork()).ldelim();
    }
    if (message.time_unix_nano !== "0") {
      writer.uint32(17).fixed64(message.time_unix_nano);
    }
    if (message.as_double !== undefined) {
      writer.uint32(25).double(message.as_double);
    }
    if (message.as_int !== undefined) {
      writer.uint32(49).sfixed64(message.as_int);
    }
    if (message.span_id.length !== 0) {
      writer.uint32(34).bytes(message.span_id);
    }
    if (message.trace_id.length !== 0) {
      writer.uint32(42).bytes(message.trace_id);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 7:
          ...
          message.filtered_attributes.push(KeyValue.decode(reader, reader.uint32()));
          continue;
        case 2:
          if (tag !== 17) {
            break;
  ...
  fromJSON(object: any): Exemplar {
    return {
      filtered_attributes: globalThis.Array.isArray(object?.filtered_attributes)
  ...
  toJSON(message: Exemplar): unknown {
    const obj: any = {};
    if (message.filtered_attributes?.length) {
      obj.filtered_attributes = message.filtered_attributes.map((e) => KeyValue.toJSON(e));
    }
    if (message.time_unix_nano !== "0") {
      obj.time_unix_nano = message.time_unix_nano;
    }
  ...
  fromPartial<I extends Exact<DeepPartial<Exemplar>, I>>(object: I): Exemplar {
    const message = createBaseExemplar();
    message.filtered_attributes = object.filtered_attributes?.map((e) => KeyValue.fromPartial(e)) || [];
    message.time_unix_nano = object.time_unix_nano ?? "0";
    message.as_double = object.as_double ?? undefined;
    message.as_int = object.as_int ?? undefined;
